...
void TextRenderer::prepareShader(int pWidth, int pHeight)
{
	glm::mat4 projection = glm::ortho(0.0f, static_cast<GLfloat>(pWidth), 0.0f, static_cast<GLfloat>(pHeight));
	mShader->use();
...
GLuint TextRenderer::getVAO() const
{
	return mVAO;
}

GLuint TextRenderer::getVBO() const
{
	return mVBO;
}
