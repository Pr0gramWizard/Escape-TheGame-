...
public:
	/*  Functions   */
	// Constructor, expects a filepath to a 3D Torch.
	Torch(GLchar* path, glm::vec3 pPosition,glm::vec3 pRotatio,GLfloat pScale);

	// Draws the Torch, and thus all its meshes
